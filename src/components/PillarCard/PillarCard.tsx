    ...
    <Card sx={{ height: '100%' }}>
      ...
      >
        <Box sx={{ display: 'flex', justifyContent: 'space-between', width: '100%', mb: 1.5 }}>
          <Typography fontSize={28}>{pillar.emoji}</Typography>
        ...
        <Box sx={{ display: 'flex', gap: 2, width: '100%' }}>
          <Box>
            ...
            <Typography variant="body2" fontWeight={700} sx={{ color: pillar.color }}>{xp}</Typography>
          </Box>
          <Box>
            <Typography variant="caption" sx={{ color: 'text.secondary' }}>Streak</Typography>
            <Typography variant="body2" fontWeight={700}>{streak > 0 ? `${streak}d 🔥` : '—'}</Typography>
          </Box>
          <Box>
